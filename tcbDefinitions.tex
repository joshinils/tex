...
\xdefinecolor{niceYellow}{HTML}{FFBC0A}
...
\newlength{\toppadding}
\setlength{\toppadding}{3pt}
\newlength{\botmpadding}
\setlength{\botmpadding}{\toppadding}
\newcommand{\tcbBoxWidthMult}{0.95}
...
\newtcolorbox{nebenrechnung}{%
    width=\tcbBoxWidthMult\linewidth,
    flush right,
    enhanced,
    colback=bgcolor,
    colframe=gray!25!bgcolor,
...
\newtcolorbox{anmerkung}[1][]{
    ...
    center,
    coltitle=txcolor,
    colback=niceYellow!10!faintredBack,
    colframe=frameColor,
    coltext=txcolor,
    highlight math style= {enhanced, %<-- needed for the ’remember’ options
        colframe=HKS51, colback=bgcolor, boxsep=0pt},
...
\newtcolorbox[use counter=exampleNumber]{example}[2][]{
    ...
    skin=bicolor,
    lower separated=true,
    %overlay={\draw[tcbcolframe, line width=.75pt] (segmentation.west)--(segmentation.east);},
    colback=niceYellow!22.5!bgcolor,%orange!25!bgcolor,
    colbacklower=notBrightGreen!13!bgcolor,
    colframe=frameColor,
    coltext=txcolor,
    highlight math style= {enhanced, %<-- needed for the ’remember’ options
        colframe=HKS51, colback=bgcolor, boxsep=0pt},
    ...
    bottom =\botmpadding,
    breakable=true,
    title = \textbf{Beispiel \theexampleNumber} ~{#2} \phantomsection\addcontentsline{toc}{subsection}{\hspace*{0.75em}Beispiel \theexampleNumber~{#2}},
    phantomlabel={#1},
    coltitle=txcolor,
    colbacktitle=titleBackColor,
    halign=left,
...
\newtcolorbox{slideKiste}[1][\titleTodo]{
    width=\linewidth,
    center,
    colback=bgcolor, colframe=frameColor, coltext=txcolor,
    highlight math style= {enhanced, %<-- needed for the ’remember’ options
        colframe=HKS51, colback=bgcolor, boxsep=0pt},
    boxrule=.75pt,
    arc=0pt,
    ...
    bottom =\botmpadding,
    breakable=true,
    title = #1 \phantomsection\addcontentsline{toc}{subsection}{SlideKiste \arabic{slideKisteNumber} #1},
    coltitle=txcolor,
    colbacktitle=titleBackColor,
%    before upper = \tcbsubtitle{\textbf{SlideKiste \arabic{slideKisteNumber}} ~#1 \phantomsection\addcontentsline{toc}{subsection}{SlideKiste \arabic{slideKisteNumber} #1}},
    before lower = \tcbsubtitle{\textbf{Lower:}},
    subtitle style = {
        frame empty,
    },
    enhanced,
    skin=bicolor,
    lower separated=true,
    colbacklower=bgcolor,
    halign=left,
}

\AtBeginEnvironment{slideKiste}{\slideKisteEquations}
\AtEndEnvironment{slideKiste}{\restoreslideKisteequations}
\newcounter{slideKistesavedequation}
\newcounter{slideKisteNumber}
\setcounter{slideKisteNumber}{0}

\newcommand{\slideKisteEquations}{%
  \setcounter{slideKistesavedequation}{\value{equation}}%
  \setcounter{equation}{0}%
  \stepcounter{slideKisteNumber}
  \renewcommand{\theequation}{K\/\arabic{slideKisteNumber}--\arabic{equation}}%
}

\newcommand{\restoreslideKisteequations}{%
  \setcounter{equation}{\value{slideKistesavedequation}}%
}

\AtBeginEnvironment{slideKiste}{
    \if@eqInTOC
        \renewcommand{\addequation}{\phantomsection\addcontentsline{toc}{subsubsection}{Gleichung \theequation}}
    \fi
}
