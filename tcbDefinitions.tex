...
%    title = \textbf{SATZ:},
    coltitle=bgcolor,
    before upper = \tcbsubtitle{\textbf{Satz \arabic{satzNumber} #1} \addcontentsline{toc}{subsection}{Satz \arabic{satzNumber} #1}},
...
\AtBeginEnvironment{satz}{
    \renewcommand{\addequation}{\addcontentsline{toc}{subsubsection}{Gleichung \theequation}}
}
...
\AtBeginEnvironment{proof}{
    \renewcommand{\addequation}{\addcontentsline{toc}{subsubsection}{Gleichung \theequation}}
    \addcontentsline{toc}{subsection}{Beweis \arabic{proofNumber}}
}
...
\newtcolorbox{definition}[1][]{
    ...
    bottom =0pt,
    breakable=true,
    title = \textbf{Definition \arabic{definitionNumber} #1 \addcontentsline{toc}{subsection}{Definition \arabic{definitionNumber} #1}  },
    coltitle=bgcolor,
}
...
\newtcolorbox{example}[1][]{
    ...
    bottom =0pt,
    breakable=true,
    title = \textbf{Beispiel \arabic{exampleNumber} #1 \addcontentsline{toc}{subsection}{Beispiel \arabic{exampleNumber} #1} },
    coltitle=bgcolor,
}
